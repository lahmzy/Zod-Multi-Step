...
const Summary: React.FC = () => {
  ...
  return (
    <section className="flex flex-col h-full w-full justify-center items-center">
      <div>
        <div className="flex flex-col gap-4 p-3 px-4 py-8 pb-7 -mt-[80px] md:mt-0  bg-white rounded-md md:gap-5 max-w-[500px] max-h-[500px]">
          ...
          <div className="bg-magnolia py-4 px-6 flex flex-col min-w-[320px] gap-4 rounded-lg">
          ...
          <div className="px-6 flex justify-between mt-3">
            ...
            <span className="text-purplish-blue text-xl font-semibold">
