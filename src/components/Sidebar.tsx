...
const Sidebar:React.FC = () => {
  return (
    <section className='w-full rounded-none bg-sidebar-mobile min-h-[30vh] md:max-w-[250px] md:min-h-[96vh] md:bg-sidebar-desktop bg-cover bg-no-repeat md:rounded-md overflow-hidden'>
